...
const page = ({ goToReport, gotoIJR }) => {
  ...
  const options = ["PRE OPERATIVE", "POST OPERATIVE"];
  ...
  return (
    <>
      ...
      <div
        className={` h-[85%] mx-auto flex  mt-5 gap-4 ${
      ...
      >
        ...
        <div
          ...
          ${width <= 540 && height < 940 ? "h-fit" : "h-full"}`}
          style={{
          ...
          ${
            ...
            >
              ...
              >
                ...
                <div className="flex bg-[#282B30] gap-2 rounded-full p-1 w-fit items-center justify-center">
                  {options.map((option) => (
                    <div
                      key={option}
                      onClick={() => {
              ...
              <div className="grid grid-cols-1 transition-all duration-300">
                ...
                ${width < 1000 ? "mb-2" : "mb-2"} `}
                  ...
                  <div className="w-full flex justify-center items-center">
                    <p className="text-black text-2xl">No Patients Found</p>
                  </div>
                )}
              </div>
            </div>
